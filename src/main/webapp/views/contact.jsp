    ...
    <div class="container">
      <div class="row text-center align-items-center">
        <div class="col-lg-4 py-3">
          ...
          <p class="mb-0 text-secondary">Green Fields, Vaddeswaram, Andhra Pradesh 522502</p>
        </div>
        <div class="col-lg-4 py-3">
          <div class="display-4 text-center text-primary"><span class="mai-call"></span></div>
          <p class="mb-3 font-weight-medium text-lg">Phone</p>
          <p class="mb-0"><a href="#" class="text-secondary">086453 50200</a></p>
          <p class="mb-0"><a href="#" class="text-secondary">+91 9945841275</a></p>
        </div>  
        <div class="col-lg-4 py-3">
          ...
          <p class="mb-0"><a href="#" class="text-secondary">ArtAttack@gmail.com</a></p>
          <p class="mb-0"><a href="#" class="text-secondary">hello@ArtAttack.com</a></p>
        </div>
      </div>
    </div>
